...
INSERT INTO public.m_login_user(username, password, account_non_expired, account_non_locked, credentials_non_expired, enabled, sort_order, is_deleted, created_at, updated_at, timestamp) VALUES('user1@example.com', '$2a$08$WgM39QQICPN6j74BsXbpqO/wBn9RMrHjcgRfdsxAtt09.N5Wslvjq', true, true, true, true, 1, false, current_timestamp, current_timestamp, 0);
INSERT INTO public.m_login_user(username, password, account_non_expired, account_non_locked, credentials_non_expired, enabled, sort_order, is_deleted, created_at, updated_at, timestamp) VALUES('user2@example.com', '$2a$08$WgM39QQICPN6j74BsXbpqO/wBn9RMrHjcgRfdsxAtt09.N5Wslvjq', true, true, true, true, 1, false, current_timestamp, current_timestamp, 0);
INSERT INTO public.m_login_user(username, password, account_non_expired, account_non_locked, credentials_non_expired, enabled, sort_order, is_deleted, created_at, updated_at, timestamp) VALUES('user3@example.com', '$2a$08$WgM39QQICPN6j74BsXbpqO/wBn9RMrHjcgRfdsxAtt09.N5Wslvjq', true, true, true, true, 1, false, current_timestamp, current_timestamp, 0);
